...
import { QhButton } from 'my-element';

type Story = StoryObj<typeof QhButton> & { argTypes: ArgTypes };


const meta: Meta<typeof QhButton> = {
...
export const Default: Story & { args: { content: string } } = {
  ...
  render: (args: any) => ({
    ...
    template: container(
      `<qh-button v-bind="args">{{ args.content }}</qh-button>`
    ),
  }),
...
//   },
//   render: (args) => ({
//     components: { QhButton, QhButtonGroup },
//     setup() {
//       return { args };
//     },
//     template: container(`
